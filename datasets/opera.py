...
class OperaDataset(Dataset):
    ...
    def __init__(self, test_fold, args, is_test=False):
        ...
        if OperaDataset.index_dict is None:
            self._create_label_mapping()

        self.index_dict = OperaDataset.index_dict
        self.label_num = OperaDataset.label_num
    ...
    def _create_label_mapping(self):
        ...
        OperaDataset.index_dict = index_lookup
        OperaDataset.label_num = len(index_lookup)
...
def get_opera_dataloader(args, test_fold):
    """
    Create DataLoaders for the Opera dataset.
